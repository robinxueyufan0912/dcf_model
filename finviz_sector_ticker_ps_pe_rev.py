...
sector_to_tickers = {
    ...
    "TMT - e-commerce": ["UI", ],
    "Luxury": [],
    "TMT - software": ["CRM", "NOW", "ADBE", "ADSK", "TEAM", "VEEV", "PLTR", 
                       "PANW","CRWD", "NET", "OKTA", 
                       "DDOG", "SNOW", "FIG", "FROG", "GTLB",
                       "SHOP", "SE", "UBER", "DASH", "NFLX", "RBLX", "APP", "RDDT", "BKNG", "ABNB", "BABA"],
    "data center - neocloud": ["ORCL", "CRWV", "NBIS", "IREN", "WULF", "CIFR", ],
    ...
    "data center - optics" :[ "CRDO", "MTSI", "SMTC", "LITE","COHR", "FN", "CSCO", "ADI", "TXN", "APH","TEL","GLW",],
    "data center - scale cross": ["NOK",  "CIEN",],
